...
import { FaTelegramPlane, FaEnvelope, FaLinkedin, FaGithub,FaWhatsapp } from "react-icons/fa";

const Footer = () => {
  return (
        <footer className="text-white bg-darkGray" id='Contact'>
      <div className="container py-10 mx-auto -mt-1 text-center">
        ...
        <div className="flex justify-center space-x-6 text-2xl">
          {/* whatsapp */}
          <a
            href="https://wa.me/qr/SCLJGNW3ZIGYL1"
            target="_blank"
